...
#define MyAppName "Cocos2d-x ParticleEditor"
#define MyAppVersion "2.2"
#define MyAppPublisher "lizhou.zhu"
#define MyAppURL "Roland0511/Cocos2d-x-ParticleEditor-for-Windows"
#define MyAppExeName "ParticleEditor.exe"

[Setup]
; 注: AppId的值为单独标识该应用程序。
; 不要为其他安装程序使用相同的AppId值。
; (生成新的GUID，点击 工具|在IDE中生成GUID。)
AppId={{6875A4CB-3590-40DB-A795-20AA2E542741}
AppName={#MyAppName}
